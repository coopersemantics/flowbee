...
class Step {
	...
	/**
	 * Executes the given layer in the stack, until
	 * completion or an exception is caught.
	 * @returns {boolean}
	 * @protected
	 */
	_exec() {
	...
	/**
	 * Sets the value in the stack, and executes
	 * the done function, on completion.
	...
	/**
	 * Sets the done function, and starts the stack iteration.
	 * @param {function} fn
	 * @returns {void}
	 * @protected
	 */
